...
\begin{gather}
  ...
  \cov{v_{i_1}(t_k), v_{i_2}(t_l)} = \delta_{k l} \delta_{i_1 i_2} V_{i_1} 
  \,, \qquad  
...
$V_i$ --- постоянная матрица дисперсии случайных возмущений для уравнений движения;   
...
Матрицы $V_i$ будем брать одинаковыми диагональными 
\begin{gather}
  V_i = 
  \begin{bmatrix}
...
Таким образом, в коэффициенте $K^*$ активными (не равными нулю) 
...
\begin{align*}
  ...
  \bar{P}_{\chi \chi}(t_k) & = 
    ...
    B^\chi V_{\chi \chi} B^{\chi \, \mathsf{T}} 
  \,. 
\end{align*}
Этап коррекции:
\begin{align}
...
\begin{align*}
  ...
  B^\varsigma V_{\varsigma} B^{\varsigma \, \mathsf{T}}
  \,.
\end{align*}
Этап коррекции:
\begin{align}
...
равны нулю (т.~е. как бы не существуют) при вычислении текущей оценки $\hat{\chi}$ переменной $\chi$, 
что приводит к следующему выражению: 
\begin{gather}
  \bar{P}_{\chi \varsigma}(t_k) C^{\varsigma \, \mathsf{T}} = 0 
  \,, \quad \Longrightarrow \quad
  K_\chi(t_k) = 
  \bar{P}_{\chi \chi}(t_k) C^{\chi \, \mathsf{T}}
  \,, 
  \label{Bedin:eq:part-KF-Blom-K} \\
  \Lambda_\chi = 
  C^{\chi} \bar{P}_{\chi \chi}(t_k) C^{\chi \, \mathsf{T}} + 
  D W D^\mathsf{T} \,.
  \label{Bedin:eq:part-KF-Blom-Lambda}
\end{gather} 
%\begin{multline*}
  %\expect{
...
\begin{align*} 
  ...
  \,, \\ 
  \bar{P}_{\chi \chi}(t_k) & = 
  A^\chi \hat{P}_{\chi \chi}(t_{k - 1}) A^{\chi \, \mathsf{T}} + B^\chi B^{\chi \, \mathsf{T}}
  \,.
\end{align*}
Этап коррекции:
\begin{align*}
  \hat{\chi}(t_k) & = \bar{\chi}(t_k) + K_{\chi} 
  \left( 
    z(t_k) - C^{\chi}\bar{\chi}(t_k) - C^{\varsigma} \bar{\varsigma}(t_k) 
  \right)
  \,, \\ 
  \hat{P}_{\chi \chi}(t_k) & = 
  \bar{P}_{\chi \chi}(t_k) - K_{\chi} \Lambda A^\chi K_{\chi}^\mathsf{T} 
  \,.
\end{align*} 
Аппроксимация:
\begin{align*}
  K_{\chi} & = \bar{P}_{\chi \chi}(t_k) C^{\chi \, \mathsf{T}} \Lambda_\chi^\mathsf{-1}
  \,, \\ 
  \Lambda_\chi & = C^{\chi} \bar{P}_{\chi \chi}(t_k) C^{\chi \, \mathsf{T}} + D W D^\mathsf{T}
  \,. 
\end{align*}
...
\begin{align*}
  ...
  H C^{\varsigma \, \mathsf{T}} + C^{\varsigma} H^\mathsf{T} + 
  D W D^\mathsf{T}
  \,, 
\end{align*} 
...
\begin{align*}
  F_{\chi} & = 
  \sum_{i = 1}^{m}(D_{i} W D_{i}^\mathsf{T})^\mathsf{-1}
  \,, \\ 
  F_{\varsigma} & = 
  \sum_{i = 1}^{m}(D_{i} W D_{i}^\mathsf{T})^\mathsf{-1} C^{\varsigma}_j
  \,, \\ 
  H & = 
...
Уравнение наблюдения:
\begin{gather*}
  z(t_k) = C^{\chi} \chi(t_k) + C^{\varsigma} \varsigma(t_k) + D w \,. 
\end{gather*}
...
\begin{align*}
  ...
  \,, \\ 
  \hat{P}_{\chi \chi}(t_k) & = 
  \bar{P}_{\chi \chi}(t_k) - K_{\chi} \Lambda_\chi K_{\chi}^\mathsf{T}
  \,. 
\end{align*} 
Аппроксимация:
\begin{align*}
