...
\end{multline}
известное как {\it формула Иозефа} [литература!!!]. 
...
Рассмотрим блоки матрицы $\bar{P}$, участвующие в соотношении для блока $\hat{P}_{\chi_i \chi_i}$. 
Легко проверить, что  
\begin{gather*}
  \begin{bmatrix}
...
в смысле положительной определённости. 
Это матричное неравенство приводит к следующему матричному неравенству для $\hat{P}_{\chi_i \chi_i}$: 
\begin{multline}
  \hat{P}_{\chi_i \chi_i} 
  \preccurlyeq 
  (1 + \gamma) 
...
и неравенство не может быть равномерно улучшено. 
...
\begin{gather*}
  A \preccurlyeq B \; \Longrightarrow\ \; C A C^\mathsf{T} \preccurlyeq C B C^\mathsf{T} \, 
\end{gather*}
для произвольных неотрицательно определённых матриц $A$, $B$ и произвольной матрицы $C$, 
...
Аналогично можно вывести соотношения на оценку и коэффициент фильтра $K_{\varsigma_j}$ для $\varsigma_j$. 
При этом можно пользоваться новой, независимо выбранной константой $\gamma$. 
...
По видимому, впервые алгоритмы, основанные на соотношениях, близких к 
\eqref{Bedin:eq:CI-Pxx-est}, \eqref{Bedin:eq:CI-Rxx-est}, 
были предложены в \cite{CI1997} и были названы CI --- Covariance Intersection. 
Однако полное обосование было получено лишь недавно, например, в работе \cite{CI2015}. 
...
разделённый фильтр по Henk Blom, фильтр, основанный на CI. 

В качестве модельной задачи была взята задача наблюдения за воздушными судами на плоскости. 
В качестве динамики ВС использовалось прямолинейное и равномерное движение 
\eqref{Bedin:eq:x-straight-line-dynamics}. 
Использовался набор из 15 движений, начальные условия которых были выбраны случайно. 
Общий вид движений приведён на рис.~\ref{Bedin:pic:traj}. 
Длительность движений была выбрана в 1000 с. 

Наблюдающие радиолокаторы имели постоянные систематические ошибки по дальности и азимуту 
и располагались в заданных точках на плоскости. Их характеристики приведены ниже в таблице 
\begin{table*}[ht]%
...
Измерения производились 1 раз в секунду. При этом все радиолокаторы одновременно наблюдали все движения. 
На рис.~\ref{Bedin:pic:kf-dx}--\ref{Bedin:pic:kf-dr} представлены результаты работы фильтра Калмана: 
отклонения между истинными параметрами движения и оценками. 
Рассматриваются параметры: 
на рис.~\ref{Bedin:pic:kf-dx} --- 
вектор геометрического положения, отклонение рассчитывается в метрах; 
на рис.~\ref{Bedin:pic:kf-dx} --- 
вектор скорости, отклонение рассчитывается в м/с; 
на рис.~\ref{Bedin:pic:kf-dx} --- 
систематическая ошибка по азимуту, отклонение рассчитывается в ${}^\circ$; 
на рис.~\ref{Bedin:pic:kf-dx} --- 
систематическая ошибка по дальности, отклонение рассчитывается в метрах. 
 
На всех рисунках синим цветом выведен график зависимости от времени отклонения рассматриваемой величины 
для одной из случайных реализаций случайных ошибок измерений и случайных ошибок динамики. 
Такой же график, но сделанный для усреднённого отклонения по 20 реализациям показан чёрной пунктирной кривой. 
Красным показан график теоретической оценки отклонения параметра, сделанной при помощи 
истинной матрицы ковариаций, пересчитываемой по уравнению \eqref{Bedin:eq:est-cov-corr-evolution}. 
...
\vspace{-4mm}
\caption{Фильтр Калмана. Отклонение по вектору положения в метрах}%
...
\vspace{-4mm}
\caption{Фильтр Калмана. Отклонение по вектору скорости в м/с}%
...
\vspace{-4mm}
\caption{Фильтр Калмана. Отклонение для систематической ошибки по азимуту в ${}^\circ$}%
...
\vspace{-4mm}
\caption{Фильтр Калмана. Отклонение для систематической ошибки по дальности в метрах}%
...
\vspace{-4mm}
\caption{Упрощённый фильтр H. Blom. Отклонение по вектору положения в метрах}%
...
\vspace{-4mm}
\caption{Упрощённый фильтр H. Blom. Отклонение по вектору скорости в м/с}%
...
\vspace{-4mm}
\caption{Упрощённый фильтр H. Blom. Отклонение для систематической ошибки по азимуту в ${}^\circ$}%
...
\vspace{-4mm}
\caption{Упрощённый фильтр H. Blom. Отклонение для систематической ошибки по дальности в метрах}%
...
\vspace{-4mm}
\caption{Упрощённый фильтр на основе метода CI. Отклонение по вектору положения в метрах}%
...
\vspace{-4mm}
\caption{Упрощённый фильтр на основе метода CI. Отклонение по вектору скорости в м/с}%
...
\vspace{-4mm}
\caption{Упрощённый фильтр на основе метода CI. Отклонение для систематической ошибки по азимуту в ${}^\circ$}%
...
\vspace{-4mm}
\caption{Упрощённый фильтр на основе метода CI. Отклонение для систематической ошибки по дальности в метрах}%
...
\vspace{-4mm}
\caption{Сравнение разных фильтров. Отклонение по вектору положения в метрах}%
...
\vspace{-4mm}
\caption{Сравнение разных фильтров. Отклонение по вектору скорости в м/с}%
...
\vspace{-4mm}
\caption{Сравнение разных фильтров. Отклонение для систематической ошибки по азимуту в ${}^\circ$}%
...
\vspace{-4mm}
\caption{Сравнение разных фильтров. Отклонение для систематической ошибки по дальности в метрах}%
