...
относящиеся к какому-нибудь одному набору парметров --- либо $\chi_i$, либо $\varsigma_j$. 
...
Отметим, что полное обосование корректности его работы было получено лишь недавно, 
...
Чёрной пунктирной кривой показан график для усредннённого по всем 20 реализациям модуля отклонения. 
...
Оценка качества берётся в виде усредннённого по всем 20 реализациям модуля отклонения. 
